			...
			{	
				case"#FACILITY_LIST":
				{
					for(int i = 0; i < serverResponse.Responsedata.size(); i++)
					{
						...
						Integer FacilityID = (Integer)values[0];System.out.println(values[5]);
						...
						arrFacility.add(new Facility(FacilityID,FacilityArea,FacilityLocation, FacilityName, FacilityThresholder,FacilityEK));
