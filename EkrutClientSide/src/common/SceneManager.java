...
public class SceneManager 
{
	...
	{	
		String newUrl = urlResources.replace("../views", "");
        loader = new FXMLLoader(getClass().getResource(newUrl)); // Create a new FXMLLoader with the specified resource URL
        Parent root;
		try {
	...
	{	
		String newUrl = urlResources.replace("../views", "");
        loader = new FXMLLoader(getClass().getResource(newUrl));
        Parent root;
		try {
			root = loader.load();
